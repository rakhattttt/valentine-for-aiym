          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl md:text-4xl font-serif text-gray-600 mb-4">
                Пожалуйста Жаным, я тебя очень люблю
              </h2>
                  ...
                  <div className="text-center space-y-4 max-h-full">
                    ...
                    >
                      <div className="text-gray-700 text-sm md:text-base leading-relaxed font-serif px-2">
                        ...
                        <p className="mb-3 text-justify">
                          Я хочу чтобы мы были вместе, сколько бы мне не пришлось бороться. Я хочу быть с тобой каждый миг и всегда. Обещаю, что буду самым надежным для тебя человеком. Буду выбирать тебя снова и снова.
                        </p>
